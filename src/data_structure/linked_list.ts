 ...
 * @class
 * @name LinkedList
 * @description 链表类，用于生成链表数据结构
 * @param {Function} [equalsFn] 判断两个节点元素是否相等的函数，默认 defaultEquals
 * @example
 * // 创建你的链表结构
...
export default class LinkedList {
  ...
  /**
   * 创建一个链表
   * @param {function} [equalsFn] 比较相等函数；默认为 defaultEquals
   * @return {LinkedList} 返回链表实例
   */
